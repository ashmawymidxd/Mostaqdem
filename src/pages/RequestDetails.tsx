...
const RequestDetails = () => {
  ...
  const request = {
    ...
    documents: [
      ...
      { name: "العنوان الوطني", status: "مرفوع" },
      { name: "التاشيرة", status: "مرفوع" },
    ],
    status: "جديد",
  };
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold font-mono">
                  {request.employer.country_address}
                </p>
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">رقم الجوال الثاني</p>
                <p className="font-semibold">{request.worker.phone}</p>
              </div>
              <div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">سعر الخدمة</p>
              ...
              <div>
                ...
                <p className="font-semibold text-lg text-primary">
                  {request.requestInfo.mosaned}
                </p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">الموظف المسنود اليه</p>
                <p className="font-semibold text-lg text-primary">
                  {request.requestInfo.employee}
                </p>
              </div>
              <div>
